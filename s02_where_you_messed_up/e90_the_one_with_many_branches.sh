...
echo "add line $((maincommit++))" >> ./$file1
...
echo "add line 1" >> $file2
git add $file2
git commit -qm "f1: add change 1"
echo "add line 2" >> $file2
git add $file2
...
touch $file3
echo "add line 1" >> $file3
git add $file3
git commit -qm "f2: add file"
echo "add line 2" >> $file3
git add $file3
...
touch $file4
echo "add line 1" >> $file4
git add $file4
git commit -qm "f3: add file"
echo "add line 2" >> $file4
git add $file4
