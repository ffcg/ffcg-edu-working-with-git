...
echo -e "add line 1 to $file1" >> ./$file1
git commit -qam "add change 1"
#echo -e "add line 1 to $file2" >> ./$file2
#git commit -qam "add change 2"
#echo -e "add line 1 to $file3" >> ./$file3
...
echo -e "add feature line 1 to $file1" >> ./$file1
git commit -qam "add feature change 1"
#echo -e "add feature line 1 to $file2" >> ./$file2
#git commit -qam "add feature change 2"
#echo -e "add feature line 1 to $file3" >> ./$file3
